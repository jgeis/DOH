# section_texts.py
# Centralized section text blocks for all dashboards/pages.
# Edit this file to update the section/helper text for any page.
...
SECTION_TEXTS = {
    ...
    "discharges-su-co-sud-mh": [
        "This data visual highlights emergency department (ED) discharges involving substance use as a primary factor. Data include substance types and demographic breakdowns by age group, sex assigned at birth, county, and year. Specific substances tracked are not mutually exclusive and include alcohol, nicotine, cannabis, opioids, cocaine, stimulants, and psychoactive drugs, among others.",
        "* Per data sharing agreements, ED data values less than 10 are suppressed and are displayed as <10*."
    ],
    "discharges-su-polysubstance": [
        "This section offers a comprehensive view of ED discharges involving multiple substances used simultaneously (at the same time) or sequentially (one after another). Data include substance types and demographic breakdowns by age group, sex assigned at birth, county, and year.",
        "* Per data sharing agreements, ED data values less than 10 are suppressed and are displayed as <10*."
    ],
    "dose": [
        "This data visual presents the number of emergency discharges related to nonfatal drug overdose by specific substance types (not mutually exclusive), as categorized by the CDC’s Drug Overdose Surveillance and Epidemiology (DOSE) definitions. Data elements include patient demographics (e.g., age, sex assigned at birth), discharge outcomes, and temporal trends by month and year.",
